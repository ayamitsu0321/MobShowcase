package ayamitsu.mobshowcase.block;
...
public class BlockMobShowcase extends BlockContainer {
    ...
    public BlockMobShowcase(Material blockMaterialIn) {
    ...
    public BlockMobShowcase setBoundingBox(AxisAlignedBB axisAlignedBB) {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (worldIn.getTileEntity(pos) instanceof TileEntityMobShowcase) {
            playerIn.openGui(MobShowcase.instance, 0, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (tileentity instanceof TileEntityMobShowcase) {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityMobShowcase)tileentity);
