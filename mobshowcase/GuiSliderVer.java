...
public class GuiSliderVer extends GuiButton
{
	protected TileEntityMobShowcase mobShowcase;
	private float sliderValue;
	public boolean dragging;
	
	public GuiSliderVer(TileEntityMobShowcase par1, int par2, int x, int y, String par5Str, float par6)
	{
		super(par2, x, y, 12, 72, par5Str);
		sliderValue = 0.5F;
		dragging = false;
	...
	protected void mouseDragged(Minecraft par1Minecraft, int par2, int par3)
    {
        ...
        if (dragging)
        {
            sliderValue = (float)(par3 - (yPosition + 6)) / (float)(height - 12);
    	...
    	GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        drawTexturedModalRect(xPosition, yPosition + (int)(sliderValue * (float)(height - 12)), 188, 0, 12, 12);
    }
